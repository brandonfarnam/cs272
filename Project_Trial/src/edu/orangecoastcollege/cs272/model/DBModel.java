...
public class DBModel {
		 ...
		 * @param tableName The table name, e.g. equipment
		 * @param fieldNames The field names, e.g. "id", "name", "strength", "dexterity", "intellect", "level"
		 ...
		 * 
		 * @param fields The field names, e.g. "name", "strength", "dexterity", "intellect","health","xp","level"
		 * @param values The values, e.g. "Batman", "40", "20", "22", "2", "2", "2", "2.4", "2"
